      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <Card className="p-6 mb-6 bg-gradient-to-br from-card to-card/50 border-border/20">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm text-muted-foreground block mb-2">Phone Number (Optional)</label>
              <input
                type="tel"
            ...
            <div>
              <label className="text-sm text-muted-foreground block mb-2">Address (Optional)</label>
              <input
                type="text"
