      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <Card className="p-6 mb-6 bg-gradient-to-br from-card to-card/50 border-border/20">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                defaultValue="Team Leader Alpha"
                disabled
            ...
            <div>
              ...
              <input
                type="email"
                defaultValue="team.leader@intervenia.com"
                disabled
                className="w-full px-4 py-2 bg-muted/10 border border-border/20 rounded-lg text-muted-foreground cursor-not-allowed"
              />
            ...
            <div>
              <label className="text-sm text-muted-foreground block mb-2">Team ID</label>
              <input
                type="text"
                defaultValue="TL-001"
                disabled
            ...
            <div>
              <label className="text-sm text-muted-foreground block mb-2">Zone</label>
              <input
                type="text"
                defaultValue="North District"
                disabled
                className="w-full px-4 py-2 bg-muted/10 border border-border/20 rounded-lg text-muted-foreground cursor-not-allowed"
              />
            </div>
        ...
        <div className="mt-8 flex gap-4">
          ...
          <Button variant="outline" className="border-border/30 hover:border-neon-cyan/40 bg-transparent">
            <Link href="/team-leader">Cancel</Link>
          </Button>
        </div>
      </main>
    </div>
